...
public class CurrencyCalculator {
    ...
    public static String processCommandToDollars(String input) {
        ...
        while (matcher.find()) {
            ...
            double result = number * rates.get("rubles");
    ...
    public static String processCommandToRubles(String input) {
        ...
        while (matcher.find()) {
            double number = Double.parseDouble(matcher.group(1));
            double result = number * rates.get("dollars");
    ...
    public static String evaluateDollars(String input) {
